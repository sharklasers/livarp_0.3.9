...
fg="#7D7D7D"
# window title:
l01="^s[80;12;$bg;livarp 0.3.9     WMFS² Infos]"
# infos:
l02="^s[15;35;#D7D7D7;Welcome to livarp_0.3.9 wmfs session]"
...
l13="^s[15;220;$fg;open luakit navigator:]^s[190;220;$fg;Alt + w]"
l14="^s[15;235;$fg;open firefox navigator:]^s[190;235;$fg;Super + Shift + w]"
l15="^s[15;250;$fg;open vim editor:]^s[190;250;$fg;Alt + e]"
l16="^s[15;265;$fg;open geany editor:]^s[190;265;$fg;Alt + Shift + e]"
l17="^s[15;280;$fg;open moc music player:]^s[190;280;$fg;Alt + z]"
l18="^s[15;295;$fg;open volume control:]^s[190;295;$fg;Alt + v]"
l19="^s[15;310;$fg;open weechat irc client:]^s[190;310;$fg;Alt + x]"
l20="^s[95;325;#D7D7D7;- full help available from wmfs menu -]"

frame="^R[0;0;400;15;$fg] ^R[0;328;400;2;$fg] ^R[0;0;2;330;$fg] ^R[398;0;2;330;$fg]"

wmfs -c status_surface "$xpos,$ypos,$width,$height,$bg $frame $l01 $l02 $l03 $l04 $l05 $l06 $l07 $l08 $l09 $l10 $l11 $l12 $l13 $l14 $l15 $l16 $l17 $l18 $l19 $l20"
