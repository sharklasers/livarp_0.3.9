...
# livarp_0.3.9 default shortcuts list
...
bg="#222222"
fg="#7D7D7D"
l01="^s[80;12;$bg;livarp 0.3.2      Shortcuts Help]"
...
l10="^s[15;145;$fg;open luakit navigator:]^s[190;145;$fg;Alt + w]"
l11="^s[15;160;$fg;open firefox navigator:]^s[190;160;$fg;Super + Shift + w]"
l12="^s[15;175;$fg;open vim editor:]^s[190;175;$fg;Alt + e]"
l13="^s[15;190;$fg;open geany editor:]^s[190;190;$fg;Alt + Shift + e]"
l14="^s[15;205;$fg;open moc music player:]^s[190;205;$fg;Alt + z]"
l15="^s[15;220;$fg;open volume control:]^s[190;220;$fg;Alt + v]"
l16="^s[15;235;$fg;open weechat irc client:]^s[190;235;$fg;Alt + x]"

frame="^R[0;0;350;15;$fg] ^R[0;248;350;2;$fg] ^R[0;0;2;250;$fg] ^R[348;0;2;250;$fg]"

wmfs -c status_surface "$xpos,$ypos,$width,$height,$bg $frame $l01 $l03 $l04 $l05 $l06 $l07 $l08 $l09 $l10 $l11 $l12 $l13 $l14 $l15 $l16"
