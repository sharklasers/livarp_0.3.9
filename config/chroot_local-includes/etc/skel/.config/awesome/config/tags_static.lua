...
for s = 1, screen.count() do
	...
	elseif taglist_style == 'roman' then
		...
		shifty.config.tags = {
			...
			["3"]   = { position = 3,  init = true, layout = layouts[3]},
			["4"]   = { position = 4,  init = true, layout = layouts[4]},
			["5"]   = { position = 5,  init = true, layout = layouts[5]},
			["6"]   = { position = 6,  init = true, layout = layouts[6]},
			["7"]   = { position = 7,  init = true, layout = layouts[7]},
			["8"]   = { position = 8,  init = true, layout = layouts[8]},
			["9"]   = { position = 9,  init = true, layout = layouts[9]},
		}
	end
end
